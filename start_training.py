...
# def train_tensorflow_object_detection_api(_):
def train_tensorflow_object_detection_api(base_config_path, to_save_path, dataset_path, num_steps):
    ...
    config_file_path = "{}/config/faster_rcnn_inception_v2_pets.config".format(to_save_path)
    ...
    flags.DEFINE_integer('ps_tasks', 0,
                         ...
                         'a parameter server.')
    flags.DEFINE_string('train_dir', '{}'.format(checkpoint_path),
                        'Directory to save the checkpoints and training summaries.')
    flags.DEFINE_string('pipeline_config_path', '{}'.format(config_file_path),
